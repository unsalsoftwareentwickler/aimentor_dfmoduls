      ...
      <section class="chat-panel">
        <header class="chat-header">
          <div class="title-group">
            ...
            <div class="title">AkademiMentor 1 Merhabaaa.... :)</div>
          </div>
...
let state = 0;
let questions = [
  "Soru 1: Bu eğitimden ne bekliyorsun?",
  "Soru 2: İleri beslemenin temel prensiplerinden ikisini söyleyebilir misiniz?",
  "Soru 3: İleri besleme, geri bildirime göre hangi temel farklarla ayrılır?"
];
...
Hazırsan "evet" yaz, ben sana sırayla 2-3 soru soracağım. Sonrasında dilediğin kadar soru sorabilir veya eğitime devam edebilirsin.`);
  ...
  if (state > 0 && state <= questions.length) {
    ...
    setTimeout(() => {
      if (state <= questions.length) {
        ...
        addMessage("AkademiMentor", "Şimdi sıra sende! ileri besleme ve geri bildirim eğitimi hakkında dilediğin kadar soru sorabilirsin.");
      }
      setButtonState(false);
    }, 600);
    return;
